...
class App():
    ...
    def hover(self, btn, colorOnHover, colorOnLeave, colorfgOnHover, colorfgOnLeave):
        btn.bind("<Enter>", func=lambda i: btn.config(
            background=colorOnHover, foreground=colorfgOnHover))
        btn.bind("<Leave>", func=lambda i: btn.config(
            background=colorOnLeave, foreground=colorfgOnLeave))

    def show_home(self):
        self.show_background()
        self.logo = PhotoImage(file='assets\\logo.png')
        self.logo_widget = Label(
            self.root, image=self.logo, background=self.accent_color_1)
        self.logo_widget.place(x=80, y=5)
        self.decor = PhotoImage(file='assets\\decor.png')
        self.decor_widget = Label(
            self.root, image=self.decor, background=self.accent_color_1)
        self.decor_widget.place(x=60, y=250)
        self.show_menu()

    def show_menu(self):
        self.button_aboutus = Button(
            self.root, text='ABOUT US', command=self.show_about_us)
        self.button_aboutus.place(x=20, y=200, width=80, height=25)
        self.button_menu = Button(
            self.root, text='MENU', command=self.show_page_1)
        self.button_menu.place(x=20, y=225, width=80, height=25)
        self.button_recipes = Button(
            self.root, text='RECIPES', command=self.show_recipes)
        self.button_recipes.place(x=20, y=250, width=80, height=25)
        self.button_contacts = Button(
            self.root, text='CONTACTS', command=self.show_contacts)
        ...
        for i in (self.button_aboutus, self.button_menu, self.button_recipes, self.button_contacts):
            ...
            self.hover(i, self.accent_color_4, self.accent_color_1,
                       self.accent_color_3, self.accent_color_2)
    ...
    def show_page_1(self):
        ...
        self.burgerwidget = Label(
            self.root, image=self.burger, background=self.accent_color_1)
        self.burgerwidget.place(x=150, y=-30)
        self.pancakewidget = Label(
            self.root, image=self.pancake, background=self.accent_color_1)
        self.pancakewidget.place(x=-130, y=160)
        self.cupcakewidget = Label(
            self.root, image=self.cupcake, background=self.accent_color_1)
        self.cupcakewidget.place(x=200, y=330)
        self.header_burgerwidget = Label(
            self.root, text='', background=self.accent_color_1, font=self.accent_font_3, justify=LEFT, wraplength=200)
        self.header_burgerwidget['text'] = 'Burger with Vegetables'
        self.text_burgerwidget = Label(
            self.root, text='', background=self.accent_color_1, font=self.accent_font_1, justify=LEFT, wraplength=140)
        ...
        self.header_pancakewidget = Label(
            self.root, text='', background=self.accent_color_1, font=self.accent_font_3, justify=LEFT, wraplength=220)
        self.header_pancakewidget['text'] = 'Pancakes with Blueberries'
        self.text_pancakewidget = Label(
            self.root, text='', background=self.accent_color_1, font=self.accent_font_1, justify=LEFT, wraplength=100)
        ...
        self.header_cupcakewidget = Label(
            self.root, text='', background=self.accent_color_1, font=self.accent_font_3, justify=LEFT, wraplength=165)
        self.header_cupcakewidget['text'] = 'Chocolate Cupcake'
        self.text_cupcakewidget = Label(
            self.root, text='', background=self.accent_color_1, font=self.accent_font_1, justify=LEFT, wraplength=160)
        ...
        self.burgerwidget_output = Message(
            self.root, text='0', background=self.accent_color_1, width=5)
        self.burgerwidget_output.place(x=192, y=70)
        self.pancakewidget_output = Message(
            self.root, text='0', background=self.accent_color_1, width=5)
        self.pancakewidget_output.place(x=150, y=240)
        self.cupcakewidget_output = Message(
            self.root, text='0', background=self.accent_color_1, width=5)
        self.cupcakewidget_output.place(x=208, y=440)

        self.next_button = Button(
            self.root, text='>', command=self.show_page_2)
        ...
        self.hover(self.next_button, self.accent_color_4,
                   self.accent_color_1, self.accent_color_3, self.accent_color_2)
    ...
    def show_page_2(self):
        ...
        self.applepie_widget = Label(
            self.root, image=self.applepie, background=self.accent_color_1)
        self.applepie_widget.place(x=130, y=-60)
        self.browniecake_widget = Label(
            self.root, image=self.browniecake, background=self.accent_color_1)
        self.browniecake_widget.place(x=-60, y=160)
        self.cola_widget = Label(
            self.root, image=self.cola, background=self.accent_color_1)
        self.cola_widget.place(x=180, y=300)

        self.applepie_header = Label(self.root, text='', background=self.accent_color_1,
                                     font=self.accent_font_3, justify=LEFT, wraplength=200)
        self.applepie_header['text'] = 'Apple Pie with Cinnamon'
        self.applepie_text = Label(self.root, text='', background=self.accent_color_1,
                                   font=self.accent_font_1, justify=LEFT, wraplength=100)
        ...
        self.browniecake_header = Label(
            self.root, text='', background=self.accent_color_1, font=self.accent_font_3, justify=LEFT, wraplength=200)
        self.browniecake_header['text'] = 'Chocolate Brownie Cake'
        self.browniecake_text = Label(self.root, text='', background=self.accent_color_1,
                                      font=self.accent_font_1, justify=LEFT, wraplength=95)
        ...
        self.cola_header = Label(self.root, text='', background=self.accent_color_1,
                                 font=self.accent_font_3, justify=LEFT, wraplength=150)
        self.cola_header['text'] = 'Refreshing Cola'
        self.cola_text = Label(self.root, text='', background=self.accent_color_1,
                               font=self.accent_font_1, justify=LEFT, wraplength=160)
        ...
        self.applepie_output = Message(
            self.root, text='0', background=self.accent_color_1, width=5)
        self.applepie_output.place(x=192, y=70)
        self.brownie_output = Message(
            self.root, text='0', background=self.accent_color_1, width=5)
        self.brownie_output.place(x=150, y=240)
        self.cola_output = Message(
            self.root, text='0', background=self.accent_color_1, width=5)
        self.cola_output.place(x=208, y=440)

        self.previous_button = Button(
            self.root, text='<', command=self.show_page_1)
        ...
        self.hover(self.previous_button, self.accent_color_4,
                   self.accent_color_1, self.accent_color_3, self.accent_color_2)
        self.previous_button.place(x=20, y=225, width=25, height=25)

        self.price_widget_4 = Label(self.applepie_widget, text='$1.65',
                                    background=self.accent_color_1, font=self.accent_font_2, justify=LEFT, wraplength=45)
        self.price_widget_5 = Label(self.browniecake_widget, text='$1.99',
                                    background=self.accent_color_1, font=self.accent_font_2, justify=LEFT, wraplength=45)
        self.price_widget_6 = Label(self.cola_widget, text='$0.99', background=self.accent_color_1,
                                    font=self.accent_font_2, justify=LEFT, wraplength=45)
    ...
    def show_close(self):
        ...
        self.hover(self.button, self.accent_color_4, self.accent_color_1,
                   self.accent_color_3, self.accent_color_2)
    ...
    def show_next(self, i):
        if i == 'burger':
            self.button = Button(self.root, text='>',
                                 command=lambda: self.show_recipe('pancake'))
        elif i == "pancake":
            self.button = Button(self.root, text='>',
                                 command=lambda: self.show_recipe('cupcake'))
        elif i == 'cupcake':
            self.button = Button(self.root, text='>',
                                 command=lambda: self.show_recipe('applepie'))
        elif i == 'applepie':
            self.button = Button(self.root, text='>',
                                 command=lambda: self.show_recipe('brownie'))
        else:
            self.button = Button(self.root, text='>',
                                 command=lambda: self.show_recipe('burger'))
        self.button.configure(
            background=self.accent_color_1,
            foreground=self.accent_color_2,
            font=self.accent_font_1,
    ...
    def show_price(self):
        self.price_widget_1 = Label(self.burgerwidget, text='$2.50', background=self.accent_color_1,
                                    font=self.accent_font_2, justify=LEFT, anchor='e', wraplength=45)
        self.price_widget_2 = Label(self.pancakewidget, text='$6.75', background=self.accent_color_1,
                                    font=self.accent_font_2, justify=LEFT, wraplength=45)
        self.price_widget_3 = Label(self.cupcakewidget, text='$2.15', background=self.accent_color_1,
                                    font=self.accent_font_2, justify=LEFT, wraplength=45)
    ...
    def show_basket(self):
        self.basket_button = Button(
            self.root, text='🛒', command=self.get_order)
        ...
        self.hover(self.basket_button, self.accent_color_4,
                   self.accent_color_1, self.accent_color_3, self.accent_color_2)

    def show_increase(self):
        self.increase_button_1 = Button(
            self.root, text='+', command=lambda: self.increase(1, 'increase_button_1'))
        self.increase_button_2 = Button(
            self.root, text='+', command=lambda: self.increase(1, 'increase_button_2'))
        self.increase_button_3 = Button(
            self.root, text='+', command=lambda: self.increase(1, 'increase_button_3'))
    ...
    def show_decrease(self):
        self.decrease_button_1 = Button(
            self.root, text='-', command=lambda: self.decrease(1, 'decrease_button_1'))
        self.decrease_button_2 = Button(
            self.root, text='-', command=lambda: self.decrease(1, 'decrease_button_2'))
        self.decrease_button_3 = Button(
            self.root, text='-', command=lambda: self.decrease(1, 'decrease_button_3'))
    ...
    def show_about_us(self):
        ...
        self.text_widget = Label(self.root, text='', background=self.accent_color_1,
                                 font=self.accent_font_1, justify=LEFT, wraplength=260)
    ...
    def show_recipes(self):
        ...
        self.text_header = Label(self.root, text='Recipes.\n\n', background=self.accent_color_1,
                                 font=self.accent_font_3, justify=LEFT, wraplength=260)
        self.recipe_1 = Button(self.root, text='BURGERS WITH VEGETABLES',
                               command=lambda: self.show_recipe('burger'))
        self.recipe_2 = Button(self.root, text='PANCAKE WITH BLUEBERRIES',
                               command=lambda: self.show_recipe('pancake'))
        self.recipe_3 = Button(
            self.root, text='CHOCOLATE CUPCAKES', command=lambda: self.show_recipe('cupcake'))
        self.recipe_4 = Button(self.root, text='APPLE PIE WITH CINNAMON',
                               command=lambda: self.show_recipe('applepie'))
        self.recipe_5 = Button(self.root, text='CHOCOLATE BROWNIE CAKE',
                               command=lambda: self.show_recipe('brownie'))
    ...
    def show_recipe(self, i):
        ...
        self.text_widget = Label(self.root, text='', background=self.accent_color_1,
                                 font=self.accent_font_1, justify=LEFT, wraplength=260)
        self.header_widget = Label(self.root, text='', background=self.accent_color_1,
                                   font=self.accent_font_3, justify=LEFT, wraplength=260)
        if i == 'burger':
    ...
    def get_order(self):
        if self.page == 1:
            self.prods_dict_page_1 = {
                f'{self.prod_name_1}': f'{self.burgerwidget_output["text"]}', f'{self.prod_name_2}': f'{self.pancakewidget_output["text"]}', f'{self.prod_name_3}': f'{self.cupcakewidget_output["text"]}'}
            for key in self.prods_dict_page_1:
                self.tmp_dict[key] = self.prods_dict_page_1[key]
            self.order_dict.update(self.tmp_dict)
        else:
            self.prods_dict_page_2 = {
                f'{self.prod_name_4}': f'{self.applepie_output["text"]}', f'{self.prod_name_5}': f'{self.brownie_output["text"]}', f'{self.prod_name_6}': f'{self.cola_output["text"]}'}
    ...
    def bill(self):
        ...
        self.decor_widget = Label(
            self.root, image=self.decor, background=self.accent_color_1)
        self.decor_widget.place(x=60, y=250)
        self.bill_prods_widget = Label(
            self.root, text='', background=self.accent_color_1, font=self.accent_font_1, justify=LEFT, wraplength=110)
        self.bill_cost_widget = Label(self.root, text='', background=self.accent_color_1,
                                      font=self.accent_font_1, justify=RIGHT, wraplength=200)
        self.bill_total_name_widget = Label(
            self.root, text='', background=self.accent_color_1, font=self.accent_font_1, justify=LEFT, wraplength=90)
        self.bill_total_cost_widget = Label(
            self.root, text='', background=self.accent_color_1, font=self.accent_font_2, justify=LEFT, wraplength=90)

        self.prices_dict = {f'{self.prod_name_1}': f'{self.price_widget_1["text"]}', f'{self.prod_name_2}': f'{self.price_widget_2["text"]}', f'{self.prod_name_3}': f'{self.price_widget_3["text"]}',
                            f'{self.prod_name_4}': f'{self.price_widget_4["text"]}', f'{self.prod_name_5}': f'{self.price_widget_5["text"]}', f'{self.prod_name_6}': f'{self.price_widget_6["text"]}'}
        ...
        for i in range(0, len(self.tmp_list)):
            for y in range(0, self.dots_length):
                ...
                to_pay_per_position = (
                    int(quantity) * float(price.split('$')[-1]))
                to_pay_per_position_formated = "{:.2f}".format(
                    to_pay_per_position)
            ...
            if name in self.prices_dict:
                self.cost_list.append(
                    f"{''.join(i for i in self.dots)} {quantity}x {price}\nTotal: ${to_pay_per_position_formated}")
                self.dots = []
